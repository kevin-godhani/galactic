...
const ScrollButtonIcon = () => {
    ...
    return (
        <svg className="scroll-button" width="111" height="156" viewBox="0 0 111 156" fill="none" xmlns="http://www.w3.org/2000/svg" onMouseOver={() => setIsMouseOver(true)} onMouseLeave={() => setIsMouseOver(false)}>
            <g ref={scrollBtnBgOuterRef} className="scroll-button-bg-outer">
                <circle cx="55.4329" cy="55.4312" r="46.3508" transform="rotate(3.61711 55.4329 55.4312)" fill={isMouseOver ? "url(#paint0_linear_313_7232)" : "url(#paint0_linear_1589_2147)"} fillOpacity="0.3"/>
            </g>
            <g ref={scrollBtnBgInnerRef} className="scroll-button-bg-inner">
                <circle cx="55.4332" cy="55.4312" r="35.9349" transform="rotate(3.61711 55.4332 55.4312)" fill={isMouseOver ? "url(#paint1_linear_313_7232)" : "url(#paint1_linear_1589_2147)"} fillOpacity="0.6"/>
            </g>
            <path d="M1.0359 54.9465C1.1713 40.5133 7.03476 26.7249 17.3364 16.6148C27.638 6.50464 41.5339 0.900893 55.9672 1.0363C70.4005 1.1717 84.1889 7.03516 94.299 17.3368C104.409 27.6384 110.013 41.5343 109.877 55.9676" stroke={isMouseOver ? "url(#paint2_linear_313_7232)" : "url(#paint2_linear_1589_2147)"} strokeOpacity="0.5" strokeWidth="1.04159" strokeLinecap="round"/>

            <path className="scroll-button-arrow" d="M57.3489 62.2915L57.3427 63.3949L58.1984 62.6983L67.9446 54.7656L68.4684 55.6239L57.0142 64.9948L57.2016 44.3038L57.4506 44.3036L57.3489 62.2915Z" stroke={isMouseOver ? "url(#paint3_linear_313_7232)" : "url(#paint3_linear_1589_2147)"} strokeOpacity="0.5" strokeWidth="1.04159" strokeLinecap="round"/>
            <path className="scroll-button-arrow" d="M54.6335 62.2915L54.6398 63.3949L53.784 62.6983L44.0378 54.7656L43.514 55.6239L54.9682 64.9948L54.7809 44.3038L54.5319 44.3036L54.6335 62.2915Z" stroke={isMouseOver ? "url(#paint4_linear_313_7232)" : "url(#paint4_linear_1589_2147)"} strokeOpacity="0.5" strokeWidth="1.04159" strokeLinecap="round"/>

            <g className="scroll-button-text">
            ...
            <defs>
                ...
                <linearGradient id="paint0_linear_1589_2147" x1="79.6499" y1="20.5379" x2="29.9139" y2="90.8454" gradientUnits="userSpaceOnUse">
                    <stop stopColor="white"/>
                    <stop offset="1" stopColor="white"/>
                </linearGradient>
                <linearGradient id="paint1_linear_1589_2147" x1="77.8274" y1="25.225" x2="31.737" y2="87.1998" gradientUnits="userSpaceOnUse">
                    <stop stopColor="white" stopOpacity="0.5"/>
                    <stop offset="1" stopColor="white"/>
                </linearGradient>
                <linearGradient id="paint2_linear_1589_2147" x1="50.0458" y1="-1.43299" x2="64.0439" y2="107.499" gradientUnits="userSpaceOnUse">
                    <stop stopColor="white"/>
                    <stop offset="1" stopColor="white" stopOpacity="0"/>
                </linearGradient>
                <linearGradient id="paint3_linear_1589_2147" x1="55.4492" y1="44.2574" x2="56.0947" y2="64.7371" gradientUnits="userSpaceOnUse">
                    <stop stopOpacity="0.2"/>
                    <stop offset="1"/>
                </linearGradient>
                <linearGradient id="paint4_linear_1589_2147" x1="56.5332" y1="44.2574" x2="55.8877" y2="64.7371" gradientUnits="userSpaceOnUse">
                    <stop stopOpacity="0.2"/>
                    <stop offset="1"/>
                </linearGradient>
            </defs>
